...
class TestLinkedList(unittest.TestCase):
    ...
    def test_to_string_empty(self):
        """
        String format of an empty LinkedList
        """
        self.assertEqual("[]", str(LinkedList()))
    
    def test_to_string_one_node(self):
        """
        String format of a LinkedList with one node
        """
        ll = LinkedList()
        ll.append(LinkedList(1))
        self.assertEqual("[1]", str(ll))
    
    def test_to_string_many_nodes(self):
        """
        String format of a LinkedList with many nodes
        """
        ll = LinkedList()
        ll.append(LinkedList(1))
        ll.append(LinkedList("banana"))
        ll.append(LinkedList(14.5))
        self.assertEqual("[1 -> banana -> 14.5]", str(ll))
